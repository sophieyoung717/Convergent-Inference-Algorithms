			...
			while( ( line = reader.readLine() ) != null ) {
				if(line.startsWith("node")){//create table object.
					...
					if(inVLine==-1){//singe node (prior)
						...
						Table<BigInteger> table1=new Table<BigInteger>(table.getNode(),nodes,range,splits.length);
						...
						Table<BigInteger> table1=new Table<BigInteger>(table.getNode(),nodes,range,cptsize);
